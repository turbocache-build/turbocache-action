...
exports.findTurboSummaryFile = void 0;
const fs_1 = __nccwpck_require__(7147);
const LOCATION = ".turbo/runs";
function findTurboSummaryFile() {
    const file = (0, fs_1.readdirSync)(LOCATION).find((file) => file.endsWith(".json"));
    if (!file) {
        return;
    }
    return `${LOCATION}/${file}`;
}
exports.findTurboSummaryFile = findTurboSummaryFile;
...
const fs_1 = __nccwpck_require__(7147);
const findFile_1 = __nccwpck_require__(2009);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!process.env.TURBO_RUN_SUMMARY) {
                core.error("TURBO_RUN_SUMMARY is not set. Please add 'TURBO_RUN_SUMMARY: true' to your workflow's env section.");
                core.warning("Skipping Turbocache Action.");
                return;
            }
            const file = (0, findFile_1.findTurboSummaryFile)();
            if (!file) {
            ...
            const summary = JSON.parse((0, fs_1.readFileSync)(file, "utf8"));
